	...
	<table width="100%" height="26" border="0" cellpadding="0"
			...
			<tbody>
				<tr>
					...
					<td class="fontg" style="margin-top: 2px"><a href="__ROOT__/"  target="_self" >首页</a>&gt;&gt;同乡公告</td>
				</tr>
			</tbody>
		</table>
		<div class="content">
						...
						<table width="98%" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tbody>
						 	 <?php if(is_array($ann)): $i = 0; $__LIST__ = $ann;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ann): $mod = ($i % 2 );++$i;?><tr>
										...
										<td height="30"><a href="__URL__/detail/articleid/<?php echo ($ann["articleid"]); ?>" 
											class="tList" target="_self" style='font-size:14px'><?php echo ($ann["title"]); ?></a>
											</td>
									</tr>
									<tr>
										<td width="28" align="center">&nbsp;</td>
										<td>【<?php echo ($ann["name"]); ?>】&nbsp;&nbsp; <?php echo ($ann["adminname"]); ?> &nbsp;&nbsp; [<?php echo (date('Y-m-d H:i:s',$ann["addtime"])); ?>]&nbsp;&nbsp;</td>
									</tr>
