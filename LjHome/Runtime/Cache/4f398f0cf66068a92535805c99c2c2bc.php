	...
	<table width="100%" height="26" border="0" cellpadding="0"
			...
			<tbody>
				<tr>
					...
					<td class="fontg" style="margin-top: 2px"><a href="__ROOT__/"  target="_self" >首页</a>&gt;&gt;同乡新闻</td></td>
				</tr>
			</tbody>
		</table>
		<div class="content">
						...
						<table width="98%" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tbody>
						 	 <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><tr>
										...
										<td height="30"><a href="__URL__/detail/articleid/<?php echo ($news["articleid"]); ?>" 
											class="tList" target="_self" style='font-size:14px'><?php echo ($news["title"]); ?></a>
											</td>
									</tr>
									<tr>
										<td width="28" align="center">&nbsp;</td>
										<td>【<?php echo ($news["name"]); ?>】&nbsp;&nbsp; <?php echo ($news["adminname"]); ?> &nbsp;&nbsp; [<?php echo (date('Y-m-d H:i:s',$news["addtime"])); ?>]</td>
									</tr>
