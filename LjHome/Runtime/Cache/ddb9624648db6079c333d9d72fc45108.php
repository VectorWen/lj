...
<body>
	...
	<div class="content" style="margin-top: 10px;height:600px">
	...
	<table width="100%" height="26" border="0" cellpadding="0"
			...
			<tbody>
				<tr>
					<td width="35" align="center"><img src="__PUBLIC__/Images/sp.gif" width="5" height="12"></td>
					<td class="fontg" style="margin-top: 2px"><a href="__ROOT__/"  target="_self" >首页</a>&gt;&gt;同乡活动</td></td>
				</tr>
			</tbody>
		</table>
		<div class="content">
			<div class="detail">
                <table width="100%" height="120" border="0" cellpadding="0" cellspacing="1">
                    <tbody>
                      ...
                      <td valign="top">
						<table width="98%" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tbody>
						 	 <?php if(is_array($activity)): $i = 0; $__LIST__ = $activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$activity): $mod = ($i % 2 );++$i;?><tr>
										<td width="28" align="center">
										<img src="__PUBLIC__/Images/items.gif" width="16" height="14"></td>
	
										<td height="30"><a href="__URL__/detail/activityid/<?php echo ($activity["activityid"]); ?>" 
											class="tList" target="_self" style='font-size:16px'><?php echo ($activity["title"]); ?></a>
											&nbsp;<span style="float: right;font-size:14px;">活动时间：[<?php echo (date('Y-m-d H:i:s',$activity["begintime"])); ?>] - [<?php echo (date('Y-m-d H:i:s',$activity["endtime"])); ?>]
													</span>
											</td>
									</tr>
									<tr>
										<td width="28" align="right">&nbsp;</td>
										<td align="right"><span style='font-size:14px;'>
											发起人： <?php echo ($activity["adminname"]); ?> &nbsp;&nbsp;费用：<?php echo ($activity["cost"]); ?>元&nbsp;&nbsp;状态：
												<?php if(($activity["endtime"] > time())): ?><span style="color: red;font-size: 18px">进行中</span>
                    ...
                    <tr>
                   <td align="center" style='font-size:14px'> <?php echo ($show); ?></td>
                    </tr>
                  </tbody>
                 </table>
			</div>
