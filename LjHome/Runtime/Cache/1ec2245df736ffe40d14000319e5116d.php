...
<body>
	...
	<div class="classifycontent">
		...
		<table width="100%" height="26" border="0" cellpadding="0"
			...
			tppabs="http://serv.wygk.net.cn/school/templates/T029/images/tbg.jpg"
			class="table">
			<tbody>
				<tr>
					<td width="35" align="center"><img
						src="__PUBLIC__/Images/sp.gif"
						tppabs="http://serv.wygk.net.cn/school/templates/T029/images/sp.gif"
						width="5" height="12"></td>
					<td class="fontg" style="margin-top: 2px"><p>借书声明</p></td>
				</tr>
			</tbody>
		</table>	
		...
		<div class="title" align="center">
				<?php echo ($book["bookstatetitle"]); ?>
		</div>
		<div class="detail" align="left" >
				<?php echo ($book["bookstatecontent"]); ?>
		</div>
		</div>
		</div>
