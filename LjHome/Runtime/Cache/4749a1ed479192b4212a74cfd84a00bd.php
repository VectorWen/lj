	...
	<div class="classifycontent" >
		...
		<table width="100%" height="26" border="0" cellpadding="0"
			...
			<tbody>
				<tr>
					...
					<td class="fontg" style="margin-top: 2px"><p>详情</p></td>
				</tr>
			</tbody>
		</table>
		...
		<div >
			<ul style="width:650px"> 
				<li><img class="imgc" src="<?php echo ($book["book"]["cover"]); ?>">
					<p>
						<b><?php echo ($book["book"]["bookname"]); ?></b>
					</p>
					<p>作者：<?php echo ($book["book"]["author"]); ?></p>
					<p>价格：<?php echo ($book["book"]["price"]); ?></p>
					<p>上传者：<a href="__APP__/User/getUser?userid=<?php echo ($book["offerid"]); ?>"><?php echo ($book["offeruser"]); ?></a></p>  
					...
					<span>简介：<?php echo ($book["book"]["introduction"]); ?></span></li>
			</ul>
		</div>
