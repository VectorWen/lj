	...
	<div class="classifycontent">
		...
		<table width="100%" height="26" border="0" cellpadding="0"
			...
			<tbody>
				<tr>
					...
					<td class="fontg" style="margin-top: 2px"><p>可借书籍</p></td>
				</tr>
			</tbody>
		</table>
		...
		<div class="clist">
			<ul>
				...
				<?php if(is_array($books)): $i = 0; $__LIST__ = $books;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$book): $mod = ($i % 2 );++$i;?><li><a href="__URL__/details?borrowid=<?php echo ($book["borrowid"]); ?>"> <img class="imgc"
						src="<?php echo ($book["book"]["cover"]); ?>"></a>
					<p>
					...
					<p>上传者：<a href="__APP__/User/getUser?userid=<?php echo ($book["offerid"]); ?>" target="_blank"><?php echo ($book["offeruser"]); ?></a></p>
					<p>状态：<?php if($book["status"] == 0): ?>未借
					<a href="__URL__/reserve?borrowid=<?php echo ($book["borrowid"]); ?>">预订</a>
