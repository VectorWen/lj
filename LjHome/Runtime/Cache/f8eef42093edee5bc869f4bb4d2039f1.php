...
<body>
	...
	<div class="classifycontent">
		头像：<img height="100" src="__PUBLIC__/Images/Head/defaule_header.jpg"/><br />
		title：<?php echo ($fb["title"]); ?><br />
		content：<?php echo ($fb["content"]); ?><br />
		用户名：<?php echo ($fb["User"]["username"]); ?><br />
		time：<?php echo (time2str($fb["time"])); ?><br />
		<?php if($fb["user_id"] == $user_id): ?><a href="__URL__/delete?id=<?php echo ($fb["feedback_id"]); ?>">删除</a><?php endif; ?>
		<hr />
		<?php if(is_array($fbComment)): $i = 0; $__LIST__ = $fbComment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>头像：<img height="50" src="__PUBLIC__/Images/Head/defaule_header.jpg"/><br />
			...
			<?php if($v["user_id"] == $user_id): ?><a href="__URL__/delComment?id=<?php echo ($v["comment_id"]); ?>">删除</a><?php endif; ?>
