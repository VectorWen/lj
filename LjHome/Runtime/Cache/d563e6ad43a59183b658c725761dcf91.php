									...
									<tbody>
										<tr class="list">
											...
											<td height="27" width="100%"
												...
												height="14"> <a href="__APP__/Source" class="class"
												target="_self">同乡资源</a>&nbsp;
										...
										<tr class="list">
											...
											<td height="27" width="100%"
												...
												<img src="__PUBLIC__/Images/items.gif" width="16"
												height="14"> <a href="__APP__/Source/mySource" class="class"
												target="_self">我的资源</a>&nbsp;
										...
										<tr class="list">
											...
											<td height="27" width="100%"
												...
												<img src="__PUBLIC__/Images/items.gif" width="16"
												height="14"> <a href="__APP__/Source/state" class="class"
												target="_self">资源声明</a>&nbsp;
	...
	<table width="100%" height="30" border="0" cellpadding="0"
			...
			<tbody>
				<tr>
					...
					<td class="fontg" style="margin-top: 2px"><p>资源共享&gt;&gt;同乡资源</p></td>
				</tr>
			</tbody>
		</table>
		...
		<form id="upload" action="__URL__/upload" method="post" enctype="multipart/form-data" >
		 <table  border="0" cellpadding="0" cellspacing="0">
		 	<tr>
		 	<td>
			<b style="font-size:18px">上传资源：</b><input type="file" name="file"/>
			<input type="hidden" value="<{Think.session.userid}>" name="userid">
			</td>
			<td> 
			<img title="上传" id="uploadfile" src="__BUTTON__/uploadpbtn.png" class="btn">
			</td>
			</tr>
			</table>
			</form>
		</div>
	<div  id="download_list"  align="center">
			<?php if(is_array($source)): $i = 0; $__LIST__ = $source;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$source): $mod = ($i % 2 );++$i;?><div style="height:10px"></div>
		  		  <table width="80%"  border="0" cellpadding="0" cellspacing="0" id="source">
		  		  		<tr>
		  		  			<td id="sourcename" width="85%" align="center" style="font-size: 18px;color:#107cc5"><b><?php echo ($source["showname"]); ?></b></td>
		  		  			<td rowspan="2" align="center">
		  		  			<a href="__URL__/download/sourceid/<?php echo ($source["sourceid"]); ?>"><img class="btn" title="下载" src="__BUTTON__/downloadpbtn.png" width="30" height="30"></a>
		  		  			</td>
		  		  			</tr>
		  		  			<tr>
		  		  			<td>
								<table width="100%"  border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											<td width="25%"><b>共享人：</b><?php echo ($source["username"]); ?></td>
											<td width="22%"><b>下载次数：</b><?php echo ($source["downloadcount"]); ?></td>
											<td width="33%"><b>共享日期：</b><?php echo (date('Y-m-d',$source["addtime"])); ?></td>
										</tr>
										</table>
							</td>
		  		  			</tr>
