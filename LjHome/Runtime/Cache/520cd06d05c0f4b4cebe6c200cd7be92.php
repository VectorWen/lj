									...
									<tbody>
										<tr class="list">
											...
											<td height="27" width="100%"
												...
												height="14"> <a href="__URL__/about" class="class"
												target="_self">廉盟介绍</a>&nbsp;
										...
										<tr class="list">
											...
											<td height="27" width="100%"
												...
												<img src="__PUBLIC__/Images/items.gif" width="16"
												height="14"> <a href="__URL__/contact" class="class"
												target="_self">联系我们</a>&nbsp;
	...
	<table width="100%" height="26" border="0" cellpadding="0"
			...
			<tbody>
				<tr>
					...
					<td class="fontg" style="margin-top: 2px;"><p>联系我们</p></td>
				</tr>
			</tbody>
		</table>
			<div class="content">
				<div class="title" align="center">
					<?php echo ($contact["contacttitle"]); ?>
				</div>
			<div class="detail" align="center" style="font-size:15px">
				<table width="28%" height="26" border="0" cellpadding="0" cellspacing="0" >
					<tr>
						<td><b>地址：</b></td>
						<td><?php echo ($contact["contactaddress"]); ?></td>
					</tr>
					...
					<tr>
						<td><b>邮编：</b></td>
						<td><?php echo ($contact["contactpostcode"]); ?></td>
					</tr>
					<tr>
						<td><b>mail：</b></td>
					...
					<tr>
						<td><b>网站：</b></td>
						<td><?php echo ($contact["contactwebsite"]); ?></td>
					</tr>
